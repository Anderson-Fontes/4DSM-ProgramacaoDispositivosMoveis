  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        <Stack.Screen name="AdminSolicitacoes" component={AdminSolicitacoesScreen} options={{ title: 'Gestão de Solicitações' }} />

        {/* ✅ NOVO: Gestão de Cursos */}
        <Stack.Screen name="ListaCursos" component={ListaCursosScreen} options={{ title: 'Gerenciar Cursos' }} />
